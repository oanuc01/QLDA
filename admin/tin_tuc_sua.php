...
<html lang="en">
  <head>
    ...
    <title>DumBum | Trang sửa tin tức</title>
              ...
              <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                      <input class="form-control" id = "txtMoTa" name="txtMoTa" placeholder = "Mô tả nội dung chính bài viết" type="text" class="form-control" value="<?php echo $row["mo_ta"];?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                      <input name="txtAnhMinhHoa" type="file" class="form-control" value="/<?php echo $row['anh_minh_hoa'];?>">
                    </div>
                  </div>
                  <br><br><br>
                  ...
                  <div>
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                      <textarea name="txtNoiDung" class="form-control col-md-7 col-xs-12" id = "txtNoiDung" name="txtNoiDung" placeholder = "Nội dung chi tiết bài viết" ><?php echo $row["noi_dung"];?></textarea>
                    </div>
                  </div>
                  <br><br><br><br>
