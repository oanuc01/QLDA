...
<html lang="en">
  <head>
    ...
    <title>DumBum | Trang quản trị tin tức</title>
                   ...
                   <table class="table table-bordered">
                      ...
                      ;?>
                        ...
                        <tr>
                          ...
                          <td><a href="tin_tuc_sua.php?id=<?php echo $row['tin_tuc_id'];?>"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a></td>
                          <td><a href="tin_tuc_xoa.php?id=<?php echo $row['tin_tuc_id'];?>"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></a></td>
                        </tr>
                      <?php
                      }
                      ;?>
