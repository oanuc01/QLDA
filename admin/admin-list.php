...
<html lang="en">
  <head>
    ...
    <title>DumBum | Trang quản trị người dùng</title>
                   ...
                   <table class="table table-bordered">
                      ...
                      ;?>
                        ...
                        <tr>
                          ...
                          <td><a href="admin-sua.php?id_nd=<?php echo $row['nguoi_dung_id'];?>"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a></td>
                          <td><a href="admin-xoa.php?id_nd=<?php echo $row['nguoi_dung_id'];?>"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></a></td>
                        </tr>
                      <?php
                      }
                      ;?>
