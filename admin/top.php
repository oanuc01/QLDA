            <div class="logo"><a href="index.php" class="site_title"> <img style="width: 90%; height: auto;" src="images/logo1.png"></a></div>
            <div class="clearfix"></div>

            <!-- menu profile quick info -->
            <div class="profile clearfix">
              <div class="profile_pic">
                <img style="width: 80%;" src="images/dumbum.ico" alt="..." class="img-circle profile_img">
              </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu" >
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a  href="./index.php"><i class="fa fa-home"></i>Hệ thống quản lý</a></li>
                  ...
                  <li><a><i class="fa fa-table"></i> Quản trị Sản phẩm <span class="fa fa-chevron-down"></span></a>
                    ...
                    <ul class="nav child_menu">
                     ...
                     <li><a><i class="fa fa-table"></i> Quản trị Loại sản phẩm  <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="kieu-them-moi.php">Tạo Loại sản phẩm</a></li>
                      <li><a href="kieu-list.php">Danh sách Loại sản phẩm</a></li>
                    </ul>
                  </li>
          ...
          <div class="nav_menu" style="background-color:#212529">
            <nav>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a style="color: white" href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="images/dumbum.ico" alt=""> ADMIN
                    <span class=" fa fa-angle-down"></span>
                  </a>
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    <li><a href="dang_nhap.php"><i class="fa fa-sign-out pull-right"></i> Log Out</a></li>
                  </ul>
                </li>
