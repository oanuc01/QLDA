                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                      <input name="txtTensp" type="text" class="form-control" value="<?php echo $row["ten_san_pham"];?>">
                    </div>
                  </div>
                  ...
                  <br><br><br>
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                      <textarea name="txtChitiet" class="form-control col-md-7 col-xs-12"><?php echo $row["chi_tiet"];?></textarea>
                    </div>
                  </div>
                  <br><br><br><br>
                  ...
                  <br><br><br>
                           ...
                           <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Kiểu sản phẩm<span class="required">*</span></label>
                    <div class="col-md-9 col-sm-9 col-xs-12">
                     ...
                     // Bước 2: Lấy dữ liệu từ trên đường đẫn
                        ...
                        ;?>
                            <option value="<?php echo $row1["kieu_san_pham_id"];?>"><?php echo $row1["kieu_san_pham"];?></option>
                        <?php
                            }
                        }
                        ;?>
